...
export const getAssistantItemsForToolRound = (response) =>
...
export const buildNextConversation = async (
  conversation,
  assistantItems,
  handlers,
) => {
  const toolCalls = assistantItems.filter(
  ...
  return [...conversation, ...assistantItems, ...toolResults];
};
